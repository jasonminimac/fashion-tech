# BOOT.md — Fashion Tech Rigging & Animation Engineer

Run this sequence every session, in order:

1. Read `agents/rigging/SOUL.md` — who I am
2. Read `agents/rigging/PROFILE.md` — my identity
3. Read `agents/rigging/MIND/logs/` — most recent daily log (today, then yesterday)
4. Read `agents/rigging/state/SESSION.md` — what I was doing
5. Check `comms/inbox/rigging/` — any new messages?
