# BOOT.md — Fashion Tech Garment & Cloth Simulation Engineer

Run this sequence every session, in order:

1. Read `agents/garments/SOUL.md` — who I am
2. Read `agents/garments/PROFILE.md` — my identity
3. Read `agents/garments/MIND/logs/` — most recent daily log (today, then yesterday)
4. Read `agents/garments/state/SESSION.md` — what I was doing
5. Check `comms/inbox/garments/` — any new messages?
