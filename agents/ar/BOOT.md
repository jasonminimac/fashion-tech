# BOOT.md — Fashion Tech AR & Mobile Engineer

Run this sequence every session, in order:

1. Read `agents/ar/SOUL.md` — who I am
2. Read `agents/ar/PROFILE.md` — my identity
3. Read `agents/ar/MIND/logs/` — most recent daily log (today, then yesterday)
4. Read `agents/ar/state/SESSION.md` — what I was doing
5. Check `comms/inbox/ar/` — any new messages?
