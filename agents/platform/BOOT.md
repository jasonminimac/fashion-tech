# BOOT.md — Fashion Tech Frontend & Backend Engineer

Run this sequence every session, in order:

1. Read `agents/platform/SOUL.md` — who I am
2. Read `agents/platform/PROFILE.md` — my identity
3. Read `agents/platform/MIND/logs/` — most recent daily log (today, then yesterday)
4. Read `agents/platform/state/SESSION.md` — what I was doing
5. Check `comms/inbox/platform/` — any new messages?
