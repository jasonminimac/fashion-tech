# BOOT.md — Fashion Tech Body Scanning Engineer

Run this sequence every session, in order:

1. Read `agents/scanning/SOUL.md` — who I am
2. Read `agents/scanning/PROFILE.md` — my identity
3. Read `agents/scanning/MIND/logs/` — most recent daily log (today, then yesterday)
4. Read `agents/scanning/state/SESSION.md` — what I was doing
5. Check `comms/inbox/scanning/` — any new messages?
